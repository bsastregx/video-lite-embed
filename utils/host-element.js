export function hostElement(comp, config) {
    const eventsBuffer = [];
    ...
    if (config.events) {
        ...
        events.forEach(event => {
            ...
            if (event[1]) {
                ...
                const eventFound = eventsBuffer.find(eventBuffer => eventBuffer["eventType"] === event[0]);
                if (eventFound) {
...
//# sourceMappingURL=host-element.js.map