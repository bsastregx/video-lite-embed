...
let GwdsVideoLite = class GwdsVideoLite extends LitElement {
    constructor() {
        super(...arguments);
        this.bgColor = 'white';
...
], GwdsVideoLite.prototype, "bgColor", void 0);
__decorate([
    property({ type: Boolean })
], GwdsVideoLite.prototype, "pt0", void 0);
__decorate([
    property({ type: Boolean })
], GwdsVideoLite.prototype, "pb0", void 0);
__decorate([
    state()
], GwdsVideoLite.prototype, "textColor", void 0);
GwdsVideoLite = __decorate([
    customElement('gwds-video-lite')
], GwdsVideoLite);
export { GwdsVideoLite };
// Register custom element
customElements.define('lite-youtube', LiteYTEmbed);
//# sourceMappingURL=gwds-video-lite.js.map